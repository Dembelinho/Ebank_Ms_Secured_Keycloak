...
public class CurrencyGraphQLController {
  ...
  private WalletTransactionRepository walletTransactionRepository;
    ...
    public Wallet addWallet(@Argument String currencyCode, @Argument double initialBalance,
        ...
        AccessToken accessToken = authenticationToken.getAccount().getKeycloakSecurityContext().getToken();
        String username = accessToken.getPreferredUsername();
        return walletService.newWallet(currencyCode,initialBalance,username);
    }
    @MutationMapping
    @PreAuthorize("hasAuthority('ADMIN')")
    public List<Wallet> walletTransfer(@Argument String sourceWalletId,@Argument String destinationWalletId,
                                       @Argument double amount) throws Exception {
